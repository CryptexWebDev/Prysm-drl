...
type AttestationData struct {
	...
	Index           github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.CommitteeIndex `protobuf:"varint,2,opt,name=index,proto3" json:"index,omitempty" cast-type:"github.com/Dorol-Chain/Prysm-drl/v5/consensus-types/primitives.CommitteeIndex"`
