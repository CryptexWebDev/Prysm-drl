...
type AggregateAttestationAndProof struct {
	...
	AggregatorIndex github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.ValidatorIndex `protobuf:"varint,1,opt,name=aggregator_index,json=aggregatorIndex,proto3" json:"aggregator_index,omitempty" cast-type:"github.com/Dorol-Chain/Prysm-drl/v5/consensus-types/primitives.ValidatorIndex"`
