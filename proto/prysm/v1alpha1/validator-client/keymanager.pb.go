...
import (
	...
	github_com_prysmaticlabs_prysm_v5_consensus_types_validator "github.com/Dorol-Chain/Prysm-drl/v5/consensus-types/validator"
...
type SignRequest struct {
	...
	SigningSlot github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Slot `protobuf:"varint,6,opt,name=signing_slot,json=signingSlot,proto3" json:"signing_slot,omitempty" cast-type:"github.com/Dorol-Chain/Prysm-drl/v5/consensus-types/primitives.Slot"`
}
...
type SignRequest_Slot struct {
	Slot github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Slot `protobuf:"varint,105,opt,name=slot,proto3,oneof" cast-type:"github.com/Dorol-Chain/Prysm-drl/v5/consensus-types/primitives.Slot"`
}

type SignRequest_Epoch struct {
	Epoch github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Epoch `protobuf:"varint,106,opt,name=epoch,proto3,oneof" cast-type:"github.com/Dorol-Chain/Prysm-drl/v5/consensus-types/primitives.Epoch"`
}
...
type BuilderConfig struct {
	...
	GasLimit github_com_prysmaticlabs_prysm_v5_consensus_types_validator.Uint64 `protobuf:"varint,2,opt,name=gas_limit,json=gasLimit,proto3" json:"gas_limit,omitempty" cast-type:"github.com/Dorol-Chain/Prysm-drl/v5/consensus-types/validator.Uint64"`
...
var file_proto_prysm_v1alpha1_validator_client_keymanager_proto_rawDesc = []byte{
	...
	0x74, 0x74, 0x65, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xbd, 0x10, 0x0a, 0x0b, 0x53,
	...
	0x6f, 0x6f, 0x66, 0x45, 0x6c, 0x65, 0x63, 0x74, 0x72, 0x61, 0x12, 0x68, 0x0a, 0x0c, 0x73, 0x69,
