# Prysm for Dorol blockchain network

This is a fork of the Prysm Ethereum 2.0 client, modified to work with the Dorol blockchain network.
Please don't use this client for Ethereum 2.0 mainnet, as it will not work.
